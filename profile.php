	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="logo.png" style="height: 35px;"></a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span> Product</a></li>
				<li><a href="about.php"><span class="glyphicon glyphicon-home"></span> About</a></li>
		...
		<div class="row">
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					...
					<div class="panel-footer"> <center>Developed by <b>Yogesh Vyas</b> &copy;<?php echo date("Y"); ?></center></div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
